...
const char *model =
	...
	"RT-N56UB1";
#elif defined(CONFIG_RTAC1200GA1)
	"RT-AC1200GA1";
#elif defined(CONFIG_RTAC1200GU)
	"RT-AC1200GU";
#elif defined(CONFIG_RTAC1200HP)
	"RT-AC1200HP";
#elif defined(CONFIG_N11P)
	"RT-N11P";
#elif defined(CONFIG_RTAC1200)
	"RT-AC1200";
#elif defined(CONFIG_RPAC56)
	"RP-AC56";
#elif defined(CONFIG_RPAC87)
	"RP-AC87";
#elif defined(CONFIG_RTAC85U)
	"RT-AC85U";
#elif defined(CONFIG_RTAC85P)
	"RT-AC85P";
#elif defined(CONFIG_RTE8820S)
	"RT-E8820S";
