...
CPPFLAGS += -DASUS_PRODUCT
endif

ifeq ($(CONFIG_RTN14U),y)  
CPPFLAGS += -DASUS_RTN14U -DHWNAT_FIX -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC52U),y)
CPPFLAGS += -DASUS_RTAC52U -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTAC51U),y)
CPPFLAGS += -DASUS_RTAC51U -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTAC51UP),y)
CPPFLAGS += -DASUS_RTAC51UP -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTN54U),y)
CPPFLAGS += -DASUS_RTN54U -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTAC54U),y)
CPPFLAGS += -DASUS_RTAC54U -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTN56UB1),y)
CPPFLAGS += -DASUS_RTN56UB1 -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_SHRINK),y)
CPPFLAGS += -DSHRINK_UBOOT
CFLAGS += -DSHRINK_UBOOT
endif

ifeq ($(CONFIG_RPAC56),y)
CPPFLAGS += -DASUS_RPAC56 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC1200),y)
CPPFLAGS += -DASUS_RTAC1200 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC1200GA1),y)
CPPFLAGS += -DASUS_RTAC1200GA1 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC1200GU),y)
CPPFLAGS += -DASUS_RTAC1200GU -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC1200HP),y)
CPPFLAGS += -DASUS_RTAC1200HP -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTN11P),y)
CPPFLAGS += -DASUS_RTN11P -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RPAC87),y)
CPPFLAGS += -DASUS_RPAC87 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC85U),y)
CPPFLAGS += -DASUS_RTAC85U -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTAC85P),y)
CPPFLAGS += -DASUS_RTAC85P -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTE8820S),y)
CPPFLAGS += -DASUS_RTE8820S -DDUAL_BAND -DBAUDRATE=115200
endif

ifeq ($(CONFIG_RTACRH26),y)
CPPFLAGS += -DASUS_RTACRH26 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RMAC2100),y)
CPPFLAGS += -DASUS_RMAC2100 -DDUAL_BAND -DBAUDRATE=57600
endif

ifeq ($(CONFIG_RTN800HP),y)
CPPFLAGS += -DASUS_RTN800HP -DBAUDRATE=57600
endif
...
CPPFLAGS += -DMTK_NAND_BMT
endif

ifeq ($(ALL_LED_OFF_RXD_GPIONR10),y)
CPPFLAGS += -DALL_LED_OFF -DALL_LED_OFF_GPIO_NR=10
endif

ifeq ($(ALL_LED_OFF_RXD_GPIONR4),y)
CPPFLAGS += -DALL_LED_OFF -DALL_LED_OFF_GPIO_NR=4
endif

ifeq ($(UBI_SUPPORT),y)
CONFIG_CMD_UBI = y
CPPFLAGS += -DCONFIG_MTD_PARTITIONS
endif
